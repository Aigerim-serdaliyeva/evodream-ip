...
if(isset($_POST["info"])) {
  ...
  $block= $source.': '.$info;
  $source = 'evodreammarketing.com/1'; //Источник, Если что спрашивать у Кирилла
  $ch=curl_init();
  ...
  $data['UF_CRM_1463741187']="evodreammarketing.com/1";
  if($_POST['keyword'])
